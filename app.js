...
async function init() {
    ...
    try {
        ...
        foodData = [
            ...
            { "id": 19, "title": "Belgian Waffles", "category": "dessert", "price": 10.50, "rating": 4.8, "img": "https://images.unsplash.com/photo-1562376552-0d160a2f238d?q=80&w=800&auto=format&fit=crop", "desc": "Crispy golden waffles topped with fresh berries, whipped cream, and maple syrup." },
            { "id": 20, "title": "Multi-Flavor Ice Cream", "category": "dessert", "price": 8.50, "rating": 4.7, "img": "https://images.unsplash.com/photo-1563805042-7684c8e9e5cb?q=80&w=800&auto=format&fit=crop", "desc": "A delightful assortment of chocolate, strawberry, and vanilla scoops." }
        ];
        restaurantData = [
